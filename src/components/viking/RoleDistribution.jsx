...
const ACADEMY_PROFESSIONS = [
  {
    name: 'Архітектор цифрових екосистем',
    icon: 'ᛟ',
    desc: "Створює та управляє цифровими платформами, що об'єднують різні сервіси, технології та користувачів.",
  },
  {
    name: 'Консультант у сфері цифрових фінансів',
    icon: 'ᚠ',
    desc: 'Допомагає компаніям та приватним особам адаптуватися до нових фінансових інструментів.',
  },
  {
    name: 'Експерт із суверенної цифрової ідентичності',
    icon: 'ᚢ',
    desc: 'Розробляє та впроваджує технології, що дозволяють людям контролювати свою цифрову безпеку.',
  },
  {
    name: 'Оператор цифрових екосистем',
    icon: 'ᚦ',
    desc: 'Забезпечує безперебійну роботу платформ, інтегруючи нові технології та відстежуючи їх ефективність.',
  },
  {
    name: 'Експерт з токенізації активів',
    icon: 'ᚹ',
    desc: 'Консультує щодо переведення реальних активів (нерухомості, товарів, інтелектуальної власності) у цифрову форму з використанням технології блокчейн.',
  },
  {
    name: 'Розробник метаресурсів',
    icon: 'ᚷ',
    desc: 'Створює унікальні метаактиви та інфраструктурні компоненти для Системи Bitbon.',
  },
  {
    name: 'Експерт з цифрового права та метаактивів',
    icon: 'ᛖ',
    desc: 'Спеціалізується на правовому регулюванні суспільних відносин користувачів у децентралізованих інформаційних платформах.',
  },
  {
    name: 'Промт-інженер у сфері штучного інтелекту',
    icon: 'ᛊ',
    desc: 'Розробляє стратегії взаємодії зі штучним інтелектом, створюючи та оптимізуючи текстові, голосові та візуальні запити. Налаштовує моделі для вирішення спеціалізованих бізнес-задач, створює персоналізовані інтерфейси.',
  },
]
...
const CERT_TYPES = [
  {
    icon: '🔍',
    name: 'Дослідник інформаційної економіки',
    level: 'Базовий',
    color: '#60a5fa',
    desc: 'Базовий сертифікат для засвоєння концепцій цифрової та платформенної економіки. Онлайн-курс за книгою «Інформаційна економіка за 90 секунд» у форматі самопідготовки.',
  },
  {
    icon: '🧭',
    name: 'Навігатор інформаційної економіки',
    level: 'Просунутий',
    color: '#a78bfa',
    desc: 'Поглиблений сертифікат, що охоплює 10 базових курсів: блокчейн, штучний інтелект, бізнес-моделі платформ. Включає інтерактивні завдання та групові проекти.',
  },
  {
    icon: '💎',
    name: 'Майстер цифрових рішень',
    level: 'Спеціалізація',
    color: '#34d399',
    desc: 'Спеціалізовані сертифікати для професіоналів у конкретних галузях — юриспруденції, маркетингу, бухобліку, кібербезпеці.',
  },
  {
    icon: '🏛',
    name: 'Архітектор цифрових трансформацій',
    level: 'Флагманський',
    color: '#fbbf24',
    desc: 'Флагманська програма для майбутніх лідерів цифрових трансформацій. Поєднує онлайн-курси, офлайн-воркшопи та роботу над реальними проектами.',
  },
]

const CERT_POINTS = [
  { icon: '🎓', bold: 'Підтвердження Вашого статусу та компетенцій', text: ' — сертифікат засвідчує Ваші знання та професійні навички, отримані в Академії.' },
  { icon: '🔑', bold: 'Доступ до сервісів та інструментів', text: ' — надає Вам право працювати з ключовими цифровими сервісами.' },
  { icon: '🌐', bold: 'Участь у розвитку цифрової екосистеми', text: ' — Ви є частиною глобального Співтовариства, яке створює цифрове майбутнє.' },
  { icon: '🤝', bold: 'Прозорість та довіра', text: ' — цей сертифікат підтверджує Ваші роль та статус, зміцнюючи довіру при взаємодії з іншими Користувачами.' },
  { icon: '⭐', bold: 'Зростання репутації', text: ' — сертифікати впливають на розрахунок Вашої репутації в Спільноті Системи Bitbon за допомогою сервісу АУРА (Агрегований Рівень Репутації Акаунта).' },
]
...
export function AcademyFace({ onFlipBack, defaultTab = 'roles' }) {
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      >
        <div className="flex flex-col items-center gap-2 text-center">
          <p className="text-[20px] text-zinc-200 font-semibold leading-snug">
            Академія Платформенної Економіки — освітня програма Системи Bitbon
          </p>
          <p className="text-[13px] text-zinc-400 leading-relaxed">
            Ви отримуєте знання, статус та інструменти для участі в децентралізованій цифровій екосистемі Web4.
          </p>
      ...
      >
        {[{ key: 'roles', label: 'Ролі' }, { key: 'professions', label: 'Професії' }].map(({ key, label }) => (
          <button
            key={key}
            onClick={() => setTab(key)}
          ...
          <div className="p-4 flex flex-col gap-3" style={{ background: 'rgba(8,8,20,0.9)' }}>
            <div>
              <h3 className="text-base font-bold text-white leading-snug">
                Визнання та підтвердження Ваших знань
              </h3>
              <p className="text-[13px] text-zinc-400 leading-relaxed mt-2">
                За результатами проходження освітніх програм Академії Ви отримуєте багатофункціональний сертифікат, який відкриває доступ до широкого спектру функціональних можливостей екосистеми цифрових сервісів «Система <span className="font-bold text-zinc-300">Bitbon</span>».
              </p>
              <p className="text-[13px] text-zinc-500 mt-2">
                Чому цей сертифікат важливий?
              </p>
            </div>
      ...
      >
        <span className="text-[9px] text-zinc-600 uppercase tracking-widest">
          Академія Платформенної Економіки
        </span>
        <span className="text-xs font-bold font-mono" style={{ color: '#a78bfa' }}>
          {tab === 'roles'
            ...
            : `${ACADEMY_PROFESSIONS.length} професій Web4`}
        </span>
      </div>
    </div>
  )
